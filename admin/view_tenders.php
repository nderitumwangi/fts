...
$projected_price =$_POST['projected_price'];
$status =$_POST['status'];
...
$sql="INSERT INTO  tenders(t_no, t_name, t_category, t_description, quantity, measurement, projected_price, status, deadline_date) VALUES(:t_no, :t_name, :t_category, :t_description, :quantity, :measurement, :projected_price, :status, :deadline_date)";
...
$query->bindParam(':t_description',$t_description,PDO::PARAM_STR);
$query->bindParam(':quantity',$quantity,PDO::PARAM_STR);
$query->bindParam(':measurement',$measurement,PDO::PARAM_STR);
$query->bindParam(':projected_price',$projected_price,PDO::PARAM_STR);
$query->bindParam(':status',$status,PDO::PARAM_STR);
$query->bindParam(':deadline_date',$deadline_date,PDO::PARAM_STR);


if($query->execute())
{
    
echo "<script> alert('You have  Successfully Added A Tender' ); </script>";

echo "<script type='text/javascript'> document.location = 'view_tenders.php'; </script>";
}
...
{
$id=$_GET['del'];
$sql = "DELETE FROM tenders  WHERE t_no =:id";
$query = $dbh->prepare($sql);
$query -> bindParam(':id',$id, PDO::PARAM_STR);
$query -> execute();


echo "<script> alert('You have  Successfully Deleted a Tender! ' ); </script>";
    ...
    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="mb-2 mr-2 btn-transition btn btn-outline-primary" href="view_tenders.php?del=<?php echo $result->t_no;?>"  onclick="return confirm('Confirm  you want to delete the tender');">
              ...
              <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <form class="needs-validation" method="POST" action="" novalidate>
                                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="t_no" placeholder="" value="" required>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control"name="t_name" placeholder="" value="" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                             <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-3 mb-3 position-relative form-group">
                                            ...
                                            <select name="t_category" id="validationCategory" class="form-control" required>
                                                        <option> </option>
                                                        <option>1</option>
                                                        <option>2</option>
                                                        <option>3</option>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="t_description" placeholder="" required>
                                             <div class="valid-feedback">
                                                Looks Good !.
                                            </div>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-3 mb-3 position-relative form-group">
                                            ...
                                            <input type="text" class="form-control" name="measurement" placeholder="" required>
                                             <div class="valid-feedback">
                                                Looks good !.
                                            </div>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-row">
                                       <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="projected_price" placeholder="" value="" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                             <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-3 mb-3 position-relative form-group">
                                            ...
                                            <select name="status" id="validationCategory" class="form-control" required>
                                                        <option> </option>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="date" class="form-control" name="deadline_date" placeholder="" value="" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                             <div class="invalid-feedback">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="Submit" name="Submit" class="btn btn-primary">Add Tender</button>
                                </div>
                                </form>
...
<div class="modal fade deleteUserModal" tabindex="-1" role="dialog" aria-labelledby="deleteUserModatl" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Delete Tender</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
              <div class="main-card mb-3 card">
                            <div class="card-body">
                                <h5 class="card-title">Confirm Delete Tender</h5>
                                 <p>Confirm you want to delete this tender</p>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <button type="del" class="btn btn-primary">Delete </button>
                                </div>
