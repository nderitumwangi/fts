                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body"><h5 class="card-title">Current Tenders</h5>
                                <table class="mb-0 table table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    $sql = "SELECT * FROM applications,tenders WHERE applications.t_no= tenders.t_no  ";
                        ...
                        <form class="needs-validation" method="POST" action="" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom04" placeholder="" name="tp_no" required>
                                    <div class="invalid-feedback">
