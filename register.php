...
if(isset($_POST['submit']))
{
    ...
    $sql=" INSERT INTO  users(First_name, Last_name, Email, Department, Level , Password) VALUES(:fname, :lname, :email, :dept, :lev, :pass)";
    ...
    $query->bindParam(':lev',$lev,PDO::PARAM_STR);
        ...
        <div class="wrap-login100 p-t-190 p-b-30">
            <form class="login100-form validate-form" method="POST" action="">
                ...
                <div class="text-center w-full p-t-25 p-b-230">
                    <a href="candidate_login.php" class="txt1">
